(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const m of s.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&o(m)}).observe(document,{childList:!0,subtree:!0});function r(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(n){if(n.ep)return;n.ep=!0;const s=r(n);fetch(n.href,s)}})();const u=document.querySelector("#HEADER_JS"),h=()=>{u.innerHTML=`
 <div class="header-container container">
  ...
  `};u&&h();const g=document.querySelector("#HEADER_MENU_JS");g&&(g.onclick=()=>{u.classList.toggle("header-menu-open")});const f=document.querySelector("#MENU_NAV_JS");f&&(f.onclick=e=>{e.target.tagName==="A"&&u.classList.remove("header-menu-open")});const l=document.querySelector("#MENU_NAV_JS"),y=()=>` <li class="menu-item" data-section="about-me"  type="button">
            ПРО МЕНЕ
          </li>
          ...
          <li class="menu-item" data-section="contacts" type="button">
            КОНТАКТИ
          </li>`;l&&(l.onclick=e=>{if(e.target.dataset.section){const t=e.target.dataset.section,r=document.getElementById(t);console.log(e.target.dataset.section),r&&r.scrollIntoView({behavior:"smooth",block:"end",inline:"nearest"})}});const M=()=>{l&&(l.innerHTML=y())};M();const c=document.querySelector("#CUSTOM_SELECT_JS"),i=document.querySelector("#CUSTOM_SELECT_SMALL_JS"),d=["UA","EN"],a={current:d[0]},E=(e,t)=>`
...
`,L=()=>{c&&(c.innerHTML=p(),c.onclick=e=>{c.classList.toggle("custom-select-open");const t=e.target.dataset.value;t&&t!==a.current&&(a.current=t,c.innerHTML=p())})},_=()=>{i&&(i.innerHTML=v(),i.onclick=e=>{const t=e.target.dataset.value;t&&t!==a.current&&(a.current=t,i.innerHTML=v())})};_();L();const S=document.querySelector("#MENU_SOCIAL_JS"),b=()=>`  <a
       ...
       >
         FACEBOOK
       </a>`,w=()=>{S&&S.insertAdjacentHTML("beforeend",b())};w();const A={ua:{header:{},hero:{},"about-me":{},advice:{},quote:{},opportunities:{},requirements:{},workflow:{},assessment:{},reviews:{},footer:{},modal:{},"pop-up":{},formats:{title:"German title",button:{test:"Зписатися"}}},en:{header:{},hero:{},"about-me":{},advice:{},quote:{},opportunities:{},requirements:{},workflow:{},assessment:{},reviews:{},footer:{},modal:{},"pop-up":{},formats:{title:"Formats studing",button:{test:"Lessons!!!"}}}},N="en";function C(e,t){return t.split(".").reduce((o,n)=>o?o[n]:void 0,e)}function T(){document.querySelectorAll("[data-lang]").forEach(t=>{const r=t.getAttribute("data-lang"),o=C(A[N],r);o&&(t.textContent=o)})}T();
